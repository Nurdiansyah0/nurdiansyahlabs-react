...
export default function Footer() {
    const { t } = useLanguage()
    return (
        <footer style={{ background: '#111827', color: '#1f2937', padding: '2rem 0' }}>
            <m.div
                ...
                <div style={{ display: 'flex', gap: '1.25rem' }}>
                    <a href="https://wa.me/6282176012461" target="_blank" rel="noreferrer"
                        ...
                        style={{ color: '#1f2937', fontSize: '1.15rem', transition: 'color 0.2s', display: 'inline-flex', alignItems: 'center', minHeight: '44px' }}
