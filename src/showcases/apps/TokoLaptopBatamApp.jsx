...
export default function TokoLaptopBatamApp() {
    ...
    return (
        <div className="min-h-screen bg-white font-['Inter',sans-serif] text-slate-900 selection:bg-blue-100 selection:text-blue-900">
            {/* Header */}
            <nav className="fixed top-0 inset-x-0 h-20 bg-white/80 backdrop-blur-xl z-[100] border-b border-slate-100 px-8 flex items-center justify-between">
                <motion.div
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="text-[10px] font-bold text-slate-400 tracking-widest uppercase mt-0.5">Premium Electronics</div>
                    </div>
                </motion.div>
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-600 rounded-full text-xs font-black tracking-widest uppercase mb-6 border border-blue-100">
                            <Star size={14} fill="currentColor" /> Authorized Re-seller Batam
                        </div>
                        <h1 className="text-6xl lg:text-7xl font-black text-slate-900 tracking-tight leading-[1.05] mb-8 uppercase">
                            Upgrade Gaya <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Hidup Digitalmu</span>
                        </h1>
                        <p className="text-xl text-slate-500 mb-10 leading-relaxed max-w-xl">
                            Dapatkan perangkat elektronik premium impianmu dengan harga tangan pertama dari Batam. Bergaransi resmi, asuransi penuh, dan gratis ongkir seluruh Indonesia.
                        </p>
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex -space-x-3 items-center ml-4">
                                ...
                                <span className="text-sm font-bold text-slate-500 ml-6 uppercase tracking-tight">+2k Happy Customers</span>
                            </div>
                        </div>
                    </motion.div>
            ...
            {/* Features */}
            <section className="py-20 px-8 border-y border-slate-50 bg-slate-50/30">
                <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
                    {[
                        { icon: ShieldCheck, title: 'Garansi Resmi', desc: 'Semua produk kami memiliki garansi resmi 1-2 tahun untuk ketenangan Anda.' },
                        { icon: Truck, title: 'Gratis Ongkir', desc: 'Pengiriman aman dengan asuransi penuh ke seluruh pelosok tanah air.' },
                        { icon: CreditCard, title: 'Cicilan 0%', desc: 'Nikmati kemudahan pembayaran dengan cicilan 0% hingga 24 bulan.' }
                    ].map((f, i) => (
            ...
            {/* Catalog */}
            <section id="catalog" className="py-24 px-8 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                    <div>
                        <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-4 uppercase">Pilih Kategorimu</h2>
                        <p className="text-slate-500">Temukan perangkat terbaik yang sesuai dengan kebutuhan produktivitasmu.</p>
                    </div>
                ...
                {loading ? (
                    <div className="h-96 flex flex-col items-center justify-center gap-4">
                        ...
                        <p className="font-bold text-slate-400 uppercase">Memuat produk premium...</p>
                    </div>
                ) : (
            ...
            <footer className="bg-slate-900 py-20 px-8">
                <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 text-slate-400">
                    <div className="col-span-2">
                        ...
                        <p className="max-w-sm leading-relaxed mb-8">Pusat perbelanjaan elektronik premium termurah di Batam dengan jaminan keaslian 100% dan pengiriman asuransi ke seluruh Indonesia.</p>
                    ...
                    <div>
                        <h4 className="text-white font-black mb-6 uppercase tracking-wider text-sm">Hubungi</h4>
                        <div className="space-y-4 text-sm font-medium">
                            <p>📞 0812-7601-2461</p>
                            <p>✉️ support@batamtech.id</p>
                            <p>💬 WhatsApp (24/7)</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
                        ...
                        >
                            <div className="bg-slate-50 rounded-[32px] p-12 flex items-center justify-center relative">
                                <img src={selectedProduct.image_url} className="w-full h-auto drop-shadow-xl mix-blend-multiply" alt={selectedProduct.name} />
                                <button
                                    onClick={() => setSelectedProduct(null)}
